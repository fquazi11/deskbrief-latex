...
use Skyplan\DeskbriefLatex\LaratexPdfWasGenerated;
use Skyplan\DeskbriefLatex\LaratexPdfFailed;
use Skyplan\DeskbriefLatex\ViewNotFoundException;
...
class LaraTeX
{
    ...
    private function parseError($tmpfname, $process)
    {
        ...
        if (!File::exists($logFile)) {
            throw new LaratexException($error, 107);
        }else{
